...
public:
	...
	*/
	...
	static void StartDeviceEx(const std::string& id, const std::string& device_path, int width, int height, nim_vchat_start_device_cb_func cb);
	static void EndDeviceEx(const std::string& id);
