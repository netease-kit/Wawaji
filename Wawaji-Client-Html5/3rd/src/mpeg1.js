...
var MPEG1 = function(options) {
	...
	this.onStartRender = (options.onStartRender instanceof Function) ? options.onStartRender : function () {}
...
MPEG1.prototype.setIgnorePFrame = function (ignorePFrame) {
	this.ignorePFrame = ignorePFrame
}
...
MPEG1.prototype.decodePicture = function(skipOutput) {
	...
	// 新增是否丢弃P帧
	if (this.ignorePFrame && this.pictureType === MPEG1.PICTURE_TYPE.PREDICTIVE) {
		// console.log('ignore P frame')
		return
	} else if (this.pictureType === MPEG1.PICTURE_TYPE.INTRA) {
